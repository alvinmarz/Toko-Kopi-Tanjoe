<div class="row mt-5">
  <div class="col-md-12 mb-4">
    <h5 class="text-center">Gayopad</h5>
  </div>
  <div class="col-md-12">

    <a href="<?=base_url('product/Gayopad')?>" class="btn btn-warning text-danger">Lihat Lainnya</a>

    <div class="filters-content mt-4">

    <div class="row grid w-100">
        <!-- ============= Gayo ============= -->
        <?php foreach ($Gayopad as $mous) : ?>
          <?php if ($mous->kategori == "Gayopad") : ?>
            <div class="col-lg-4 col-md-4 all Gayopad w-100">
