...
<div class="row mt-5">
  ...
  <div class="col-md-12">
    ...
    <a href="<?=base_url('product/mouse')?>" class="btn btn-warning text-danger">Lihat Lainnya</a>

    <div class="filters-content mt-4">

    <div class="row grid w-100">
        <!-- ============= Mouse ============= -->
        <?php foreach ($mouse as $mous) : ?>
          <?php
          $path = "/uploads_barang/";
          $nama_folder = $mous->kategori;
          ?>
          <?php if ($mous->kategori == "Mouse") : ?>
            <div class="col-lg-4 col-md-4 all mouse w-100">
              <div class="product-item">
              <img src="<?= base_url() . $path, $nama_folder . '/' . $mous->gambar; ?>">
