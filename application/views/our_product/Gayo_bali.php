              ...
              <div class="product-item">
                ...
                <div class="down-content">
                  ...
                  <div class="text-center mt-auto">                    
                    <?php echo anchor('dashboard/tambah_ke_keranjang/' . $mous->id_brg, '<i class="fa fa-shopping-cart"></i> Tambah Keranjang', 'class="btn btn-danger"'); ?>
                    <?php echo anchor('dashboard/detail/' . $mous->id_brg, 'Detail', 'class="btn btn-danger"'); ?>
                    </div>
                  </div>
                </div>
              </div>
